        ...
        builder.setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (input.getText().length() != 0) {
                    ...
                    Toast.makeText(getApplicationContext(), "You can change name to: " + Data.playerName, Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(getApplicationContext(), "Name hasn't been saved, input is clear", Toast.LENGTH_LONG).show();
                }
            }
        });
        builder.show();
